...
::oPrn:Say( ::oPrn:nL++,55,       "Ocupación : " + ::aLS[5] )
...
::oPrn:Say( ::oPrn:nL  ,01,"Tipo Vinculación : " +::aLS[6] )
...
While !oApl:oCtl:EOF()
   ...
   ::ImpLine( {01,"","Acompañante :",1, 15,"",aKey[1],1 },0 )
   ::oPrn:cFont := ::oPrn:CPICompress
   ::ImpLine( {01,"","Dirección Acompañante :",1, 25,"",aKey[2],1,;
...
If ::nCtl == 0 .OR. ::nCtl == oApl:oCtl:CONTROL
   ...
   ::oPrn:cFont := ::oPrn:CPICompress
   ::ImpLine( {01,"","Dirección Acompañante :",1, 83,"",     "Telefono :",1 },0 )
...
METHOD WHClinica() CLASS TExamen
 ...
 UTILPRN ::oUtil  5.5,10.8 SAY     "Ocupación :" RIGHT
 ...
 UTILPRN ::oUtil  7.0, 3.0 SAY "Tipo Vinculación :" RIGHT
...
While !oApl:oCtl:EOF()
   ...
   ::ImpLinw( {1.5,"","Acompañante :",1, 4.2,"",aKey[1],1 },0 )
   UTILPRN ::oUtil SELECT ::aFnt[5]
   ::ImpLinw( {0.5,"","Dirección Acompañante :",1, 4.1,"",aKey[2],1,;
...
If ::nCtl == 0 .OR. ::nCtl == oApl:oCtl:CONTROL
   ...
   UTILPRN ::oUtil SELECT ::aFnt[5]
   ::ImpLinw( {1.8,"","Acompañante :",1 },0 )
   ::ImpLinw( {0.5,"","Dirección Acompañante :",1, 12.0,"",     "Telefono :",1 },0 )
